...
class BasketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create basket" do
    assert_difference("Basket.count") do
      post baskets_url, params: { basket: { discount: @basket.discount, to_pay: @basket.to_pay, total: @basket.total } }
    end
  ...
  test "should update basket" do
    patch basket_url(@basket), params: { basket: { discount: @basket.discount, to_pay: @basket.to_pay, total: @basket.total } }
